...
namespace Modules\Groups\Http\Controllers\Backend;
...
use Modules\Groups\Http\Requests\Backend\GroupRequest;
...
//    use Authorizable;
    ...
    {
        // Page Title
        $this->module_title = __('labels.backend.groups.name');

        // module name
        $this->module_name = 'groups';

        // directory path of the module
        $this->module_path = 'groups::backend';

        // module icon
        $this->module_icon = 'fas fa-layer-group';

        // module model name, path
        $this->module_model = "Modules\Groups\Entities\Group";
    }
...
//        return response()->json($$module_name);
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select('id', 'group_name', 'updated_at');
