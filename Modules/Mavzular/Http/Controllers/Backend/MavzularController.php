...
namespace Modules\Mavzular\Http\Controllers\Backend;
...
use Modules\Mavzular\Http\Requests\Backend\MavzuRequest;
...
//    use Authorizable;
    ...
    {
        // Page Title
        $this->module_title = __('labels.backend.mavzular.name');

        // module name
        $this->module_name = 'mavzular';

        // directory path of the module
        $this->module_path = 'mavzular::backend';

        // module icon
        $this->module_icon = 'fas fa-atom';

        // module model name, path
        $this->module_model = "Modules\Mavzular\Entities\Mavzu";
    }
...
//        return response()->json($$module_name);
    ...
    public function index_data()
    {
        ...
        $$module_name = $module_model::select('id',  'updated_at', 'mavzu');
     ...
     * @return Response
     */
    public function store(MavzuRequest $request)
    {
        $module_title = $this->module_title;
        $module_name = $this->module_name;
        $module_path = $this->module_path;
     ...
     * @return Response
     */
    public function update(MavzuRequest $request, $id)
    {
        $module_title = $this->module_title;
        $module_name = $this->module_name;
        $module_path = $this->module_path;
