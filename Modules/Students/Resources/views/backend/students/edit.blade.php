        ...
        <div class="row mt-4">
            <div class="col">
                ...
                <div class="form-group row">
                    <?php
                    $field_name = 'group_id';
                    $field_label = __('labels.backend.groups.fields.name');
                    $field_placeholder = __("Select an option");
                    $required = "";
                    ?>
                    {{ html()->label($field_label, $field_name)->class('col-sm-2 form-control-label') }} {!! fielf_required($required) !!}
                    <div class="col-sm-10">
                        {{ html()->select($field_name, (isset($groups) ? $groups : ''))->placeholder($field_placeholder)->class('form-control select2')->attributes(["$required"]) }}
                    </div>
                </div>
                <div class="form-group row">
