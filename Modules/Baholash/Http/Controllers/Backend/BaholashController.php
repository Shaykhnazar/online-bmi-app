...
//            })
    ...
    public function create()
    {
        ...
        $users = User::role('talaba')->get(['id', 'name'])->pluck('name','id');
    ...
    public function store(BaholashRequest $request)
    {
        ...
        $data_array['teacher_id'] = optional(auth()->user())->id;
    ...
    public function edit($id)
    {
        ...
        $users = User::role('talaba')->get(['id', 'name'])->pluck('name','id');
        $types = Mavzu::get(['id', 'mavzu'])->pluck('mavzu','id');
        $teachers= User::role('ilmiy_rahbar')->get(['id', 'name'])->pluck('name','id');
        ...
        return view(
            ...
            compact('users', 'types', 'teachers','module_title', 'module_name', 'module_path', 'module_icon', 'module_action', 'module_name_singular', "$module_name_singular")
        );
    }
